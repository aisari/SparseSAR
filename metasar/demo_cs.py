...
if isEasy:
    ...
    datafile20, ntasks, npoints = '/mnt/e/DataSets/zhi/sar/sim/meta/Hard/PointShapes/HardMetaSARTasks20Points4SceneSize64x64EchoSize64x64.h5', 20, 4

ntasks, npoints = 20, 4
nTest = ntasks * npoints

# data = tb.loadh5(datafile1500, keys=None)
